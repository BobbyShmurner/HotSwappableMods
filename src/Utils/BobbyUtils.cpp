...
namespace BobbyUtils {
	...
	void LogHierarchyRecurse(UnityEngine::Transform* trans, int parents, int level, UnityEngine::Transform* ogTrans, bool logComponents) {
	...
	void LogHierarchy(UnityEngine::Transform* trans, int parents) {
		LogHierarchyRecurse(trans, parents, 0, trans, false);
	}

	void LogComponentHierarchy(UnityEngine::GameObject* go, int parents) {
